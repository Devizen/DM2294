...
void CProjectile::Render(void)
{
	...
	modelStack.Translate(position.x, position.y, position.z);//CAH Adj Z Hypot Y A/H arc Cos
	modelStack.Rotate(Math::RadianToDegree(atan2(GetDirection().x, GetDirection().z)), 0.f, 1.f, 0.f);

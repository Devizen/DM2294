	...
	const Vector3& _scale)
{
	...
	_center->SetAABB(Vector3(_scale.x, _scale.y * 3.f, _scale.z), Vector3(-_scale.x, -10.f, -_scale.z));
	_center->SetLight(true);
	_left->SetAABB(Vector3(_scale.x, _scale.y * 3.f, _scale.z), Vector3(-_scale.x, -10.f, -_scale.z));
	_left->SetLight(true);
	_right->SetAABB(Vector3(_scale.x, _scale.y * 3.f, _scale.z), Vector3(-_scale.x, -10.f, -_scale.z));
	_right->SetLight(true);
	_up->SetAABB(Vector3(_scale.x, _scale.y * 3.f, _scale.z), Vector3(-_scale.x, -10.f, -_scale.z));
	_up->SetLight(true);
	_down->SetAABB(Vector3(_scale.x, _scale.y * 3.f, _scale.z), Vector3(-_scale.x, -10.f, -_scale.z));
	_down->SetLight(true);

	_center->setHealthTo(10);
	_center->setMaxHealthTo(10);
	_left->setHealthTo(10);
	_left->setMaxHealthTo(10);
	_right->setHealthTo(10);
	_right->setMaxHealthTo(10);
	_up->setHealthTo(10);
	_up->setMaxHealthTo(10);
	_down->setHealthTo(10);
	_down->setMaxHealthTo(10);

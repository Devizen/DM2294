...
Level03::Level03(SceneManager* _sceneMgr)
	: theMinimap(NULL)
	, theCameraEffects(NULL)
	, currentHighscore(0)
	, cinematicMode(false)
{
	_sceneMgr->AddScene("Level03", this);
}
...
void Level03::displayControls(void)
{
	std::ostringstream ss;
...
void Level03::renderWeapon(void)
{
	Mesh* modelMesh;
...
void Level03::renderWeaponUI(void)
{
	Mesh* modelMesh;
	if (playerInfo->GetWeapon() == 0)
...
void Level03::createEnemies(double dt)
{
...
void Level03::createCrates(double dt)
{
...
void Level03::createBullets(double dt)
{
...
void Level03::createHealth(double dt)
{
...
void Level03::pauseOptions(double dt, bool &pause)
{
	OptionsManager::GetInstance()->setEditingState(true);
...
void Level03::clearKeyDisplay(void)
{
	for (int i = 0; i < 17; ++i)
	{
...
void Level03::RenderPassGPass(void)
{
...
void Level03::RenderPassMain(void)
{

...
private:
	Village(SceneManager* _sceneMgr); // This is used to register to SceneManager
	...
	static Village* sInstance; // The pointer to the object that gets registered
...
template<typename T>
inline string Village::checkInput(T input)
{
	if (input == 1)
		return "Left Click";

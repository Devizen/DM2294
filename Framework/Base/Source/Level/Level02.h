...
private:
	Level02(SceneManager* _sceneMgr); // This is used to register to SceneManager
	...
	static Level02* sInstance; // The pointer to the object that gets registered
...
template<typename T>
inline string Level02::checkInput(T input)
{
	if (input == 1)
		return "Left Click";

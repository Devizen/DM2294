...
private:
	Selection(SceneManager* _sceneMgr); // This is used to register to SceneManager
	...
	static Selection* sInstance; // The pointer to the object that gets registered
	...
	void renderSelectionTitle(void);
	void renderSelectionVillage(void);
	void renderSelectionTutorial(void);
	void renderSelectionLevel1(void);
	void renderSelectionLevel2(void);
	void renderSelectionLevel3(void);
	void renderSelectionLevel4(void);
	void renderSelectionBack(void);
...
template<typename T>
inline string Selection::checkInput(T input)
{
	if (input == 1)
		return "Left Click";

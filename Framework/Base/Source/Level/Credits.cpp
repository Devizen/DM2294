...
Credits* Credits::sInstance = new Credits(SceneManager::GetInstance());
...
Credits::Credits(SceneManager* _sceneMgr)
	: theMinimap(NULL)
	, theCameraEffects(NULL)
	, loopCredits(0)
	//, currentHighscore(0)
	//, cinematicMode(false)
{
	_sceneMgr->AddScene("Credits", this);
}
...
void Credits::Update(double dt)
{
	...
	if (!Text_Manager::GetInstance()->displayingText)
	{
		if (loopCredits == 0)
		{
			Create::Text("text", "EUGENE [160540A]", 0.f, 1.f, CText::TEXT_IMPACT);
			loopCredits = 1;
		}
		else if (loopCredits == 1)
		{
			Create::Text("text", "ZHIHAO [163940Z]", 0.f, 1.f, CText::TEXT_IMPACT);
			loopCredits = 2;
		}
		else if (loopCredits == 2)
		{
			Create::Text("text", "MARCUS [161725E]", 0.f, 1.f, CText::TEXT_IMPACT);
			loopCredits = 3;
		}
		else if (loopCredits == 3)
		{
			Create::Text("text", "YU MING [160853T]", 0.f, 1.f, CText::TEXT_IMPACT);
			loopCredits = 0;
		}
	}
...
void Credits::displayControls(void)
{
...
void Credits::renderSelection(void)
{
	Mesh* modelMesh;
...
void Credits::renderSelectionTitle(void)
{
	Mesh* modelMesh;
	MS& modelStack = GraphicsManager::GetInstance()->GetModelStack();
	if (Application::GetInstance().GetWindowWidth() / Application::GetInstance().GetWindowHeight() < 1.5f)
	{
		modelMesh = MeshBuilder::GetInstance()->GetMesh("CREDITS");
		modelStack.PushMatrix();
...
void Credits::renderSelectionVillage(void)
{
	Mesh* modelMesh;
	MS& modelStack = GraphicsManager::GetInstance()->GetModelStack();
	if (Application::GetInstance().GetWindowWidth() / Application::GetInstance().GetWindowHeight() < 1.5f)
...
void Credits::renderSelectionTutorial(void)
{
	Mesh* modelMesh;
	MS& modelStack = GraphicsManager::GetInstance()->GetModelStack();
	if (Application::GetInstance().GetWindowWidth() / Application::GetInstance().GetWindowHeight() < 1.5f)
...
void Credits::renderSelectionLevel1(void)
{
	Mesh* modelMesh;
	MS& modelStack = GraphicsManager::GetInstance()->GetModelStack();
	if (Application::GetInstance().GetWindowWidth() / Application::GetInstance().GetWindowHeight() < 1.5f)
...
void Credits::renderSelectionLevel2(void)
{
	Mesh* modelMesh;
	MS& modelStack = GraphicsManager::GetInstance()->GetModelStack();
	if (Application::GetInstance().GetWindowWidth() / Application::GetInstance().GetWindowHeight() < 1.5f)
...
void Credits::renderSelectionLevel3(void)
{
	Mesh* modelMesh;
	MS& modelStack = GraphicsManager::GetInstance()->GetModelStack();
	if (Application::GetInstance().GetWindowWidth() / Application::GetInstance().GetWindowHeight() < 1.5f)
...
void Credits::renderSelectionLevel4(void)
{
	Mesh* modelMesh;
	MS& modelStack = GraphicsManager::GetInstance()->GetModelStack();
	if (Application::GetInstance().GetWindowWidth() / Application::GetInstance().GetWindowHeight() < 1.5f)
...
void Credits::renderSelectionBack(void)
{
	Mesh* modelMesh;
	MS& modelStack = GraphicsManager::GetInstance()->GetModelStack();
	if (Application::GetInstance().GetWindowWidth() / Application::GetInstance().GetWindowHeight() < 1.5f)
...
void Credits::pauseOptions(double dt, bool &pause)
{
...
void Credits::clearKeyDisplay(void)
{
	for (int i = 0; i < 17; ++i)
	{
...
void Credits::RenderPassGPass(void)
{
...
void Credits::RenderPassMain(void)
{

...
void Village::Init()
{
	...
	/*Initialise Sounds*/
	CSoundEngine::GetInstance()->GetSoundEngine()->play2D("Sound\\BGM\\VILLAGE.ogg", true);
	/*Shadow*/
...
void Village::Update(double dt)
{
	...
	else if (playerInfo->GetPos().x >= 360
	...
	else if (playerInfo->GetPos().x >= 40
	...
	else if (playerInfo->GetPos().x >= -380

...
private:
	Level01(SceneManager* _sceneMgr); // This is used to register to SceneManager
	...
	static Level01* sInstance; // The pointer to the object that gets registered
...
template<typename T>
inline string Level01::checkInput(T input)
{
	if (input == 1)
		return "Left Click";

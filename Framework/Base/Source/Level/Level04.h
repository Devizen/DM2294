...
private:
	Level04(SceneManager* _sceneMgr); // This is used to register to SceneManager
	...
	static Level04* sInstance; // The pointer to the object that gets registered
...
template<typename T>
inline string Level04::checkInput(T input)
{
	if (input == 1)
		return "Left Click";

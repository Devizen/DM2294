...
private:
	Tutorial(SceneManager* _sceneMgr); // This is used to register to SceneManager
	...
	static Tutorial* sInstance; // The pointer to the object that gets registered
...
template<typename T>
inline string Tutorial::checkInput(T input)
{
	if (input == 1)
		return "Left Click";

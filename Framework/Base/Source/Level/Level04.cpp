...
Level04* Level04::sInstance = new Level04(SceneManager::GetInstance());
...
Level04::Level04(SceneManager* _sceneMgr)
	: theMinimap(NULL)
	, theCameraEffects(NULL)
	, currentHighscore(0)
	, cinematicMode(false)
{
	_sceneMgr->AddScene("Level04", this);
}
...
void Level04::displayControls(void)
{
	std::ostringstream ss;
...
void Level04::renderWeapon(void)
{
	Mesh* modelMesh;
...
void Level04::renderWeaponUI(void)
{
	Mesh* modelMesh;
	if (playerInfo->GetWeapon() == 0)
...
void Level04::createEnemies(double dt)
{
...
void Level04::createCrates(double dt)
{
...
void Level04::createBullets(double dt)
{
...
void Level04::createHealth(double dt)
{
...
void Level04::pauseOptions(double dt, bool &pause)
{
	OptionsManager::GetInstance()->setEditingState(true);
...
void Level04::clearKeyDisplay(void)
{
	for (int i = 0; i < 17; ++i)
	{
...
void Level04::RenderPassGPass(void)
{
...
void Level04::RenderPassMain(void)
{

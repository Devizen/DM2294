...
private:
	Credits(SceneManager* _sceneMgr); // This is used to register to SceneManager
	...
	static Credits* sInstance; // The pointer to the object that gets registered
...
template<typename T>
inline string Credits::checkInput(T input)
{
	if (input == 1)
		return "Left Click";
